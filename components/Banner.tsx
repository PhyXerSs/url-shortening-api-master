        ...
        <div className="w-full h-[750px] md:h-fit md:max-w-[1440px] grid grid-rows-2 grid-cols-none md:grid-rows-none md:grid-cols-2 md:items-center md:justify-items-center gap-y-32">
            <div className="w-full max-w-[100vw] md:max-w-full flex flex-col justify-start md:justify-center items-center md:items-start gap-8 md:pl-24">
                <div className="w-full flex flex-col justify-center items-center md:items-start gap-2 px-4 md:px-0">
                    <p className="text-[50px] md:text-[80px] text-[#34313b] font-[700] leading-[60px] md:leading-[100px] md:break-normal w-full text-center md:text-start">
                        More than just shorter links
                    </p>
                    <p className="text-[21px] md:text-[24px] text-[#9c9ba3] w-full md:max-w-[600px] text-center md:text-start font-[500] break-words">{`Build your brand's recognition and get detailed insights on how your links are performing.`}</p>
                </div>
                <div className="text-white flex justify-center items-center text-[20px] font-[700] w-[180px] md:w-[200px] py-[12px] md:py-[10px] rounded-full bg-[#24d0cf] hover:bg-[#99e3e4] cursor-pointer ease-linear duration-200">
                    Get Started
                </div>
            </div>
            <div className="order-first md:order-last flex relative w-full">
                <div className="flex w-full h-full items-center pl-8 md:pl-0 md:ml-16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className='hidden' width={733} height={482}>
                            ...
                            <path
                                fill="url(#a)"
                                d="M214 384.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"
                            />
                            <circle cx={207} cy={399} r={11} fill="#25233A" />
                            <path
                                fill="#3F3D56"
                                d="M216 399.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"
                            />
                            <path
                                fill="#2BD0D0"
                            ...
                            <path
                                fill="#2BD0D0"
                                d="M226 310h14v59c0 3.866-3.133 7-6.997 7a6.999 6.999 0 0 1-6.996-7v-59H226z"
                            />
                            <path
                                fill="#2BD0D0"
                                d="m231.187 386.708-24.537 7.025c-3.568 1.014-7.314-.949-8.375-4.388-1.047-3.44.987-7.05 4.548-8.074l24.537-7.005c3.564-1.01 7.304.948 8.368 4.381 1.039 3.435-.99 7.034-4.541 8.06z"
                            />
                            <path
                                fill="url(#b)"
                                d="m236 386.26-3.125.551a12.89 12.89 0 0 1-2.875.172l1.305-.228a10.302 10.302 0 0 0 2.507-.755l2.188.26z"
                            />
                            <path
                                fill="url(#c)"
                                d="M261 372.738a6.914 6.914 0 0 1-1.46 4.262L239 372.65a7.113 7.113 0 0 0 1.098-2.462l12.654-3.923a6.201 6.201 0 0 1 4.913.579c1.5.867 2.609 2.324 3.083 4.048.164.6.249 1.222.252 1.846z"
                            />
                            <path
                                fill="url(#d)"
                                d="M225.22 371.103a5.776 5.776 0 0 1-.22-1.58V311h5.943v63.07c-.059.31-.04.627.057.93a9.278 9.278 0 0 0-2.845-.511c-.69-.04-1.385-.04-2.076 0l.425-.1c.262-.04-.94-2.091-1.283-3.286z"
                                opacity={0.31}
                            />
                            <path
                                fill="url(#e)"
                                d="M262.289 389.8a6.67 6.67 0 0 1-3.17.796 7.063 7.063 0 0 1-1.33-.13l-22.407-4.406-1.867-.363a6.54 6.54 0 0 1-2.133 1.055l-1.11.317-23.025 6.666c-3.514 1.007-7.202-.943-8.247-4.362 1.997 1.805 5.029 1.973 7.223.401 2.811-1.896 14.002-4.743 20.341-6.257 2.996-.698 5.288-3.05 5.848-6 .016-.173.042-.346.08-.517 1.056 1.113 2.997 2.362 6.505 3.423 8.64 2.589 22.667 4.304 22.667 4.304s2.532 2.42.625 5.073z"
                                opacity={0.31}
                            />
                            <path
                                fill="url(#f)"
                                d="M264 388a7.624 7.624 0 0 1-2 2 119.75 119.75 0 0 0 2-2z"
                            />
                            <path
                                fill="url(#g)"
                                d="M226.3 370.559a6.82 6.82 0 0 0 1.7 3.13c-.21.039-.425.092-.641.151L206.088 380c-3.271-.813-5.426-3.865-5.044-7.146.381-3.28 3.181-5.781 6.556-5.854a7.14 7.14 0 0 1 1.35.132l17.35 3.427z"
                            />
                            <path
                                fill="#503164"
                            ...
                            <path
                                fill="#2BD0D0"
                                d="M268 259.364 330.107 246 356 251.054 285.442 268z"
                            />
                            <path
                                fill="url(#k)"
                                d="M268 259.364 330.107 246 356 251.054 285.442 268z"
                            ...
                            <path
                                fill="#FFF"
                                opacity={0.25}
                                d="M214.334 190 210 244.055 223.238 251 234 249.122l-13.428-16.504zM284 187s17.909 42.077 9.97 57l-6.116-1.16L284 187z"
                            />
                            <path
                                fill="url(#r)"
                            ...
                            <path
                                fill="#2BD0D0"
                                d="m461.804 212.337-142.243 7.654c-3.44.181-6.376-2.47-6.561-5.926V112.473c.003-4.101 3.267-7.448 7.348-7.535l141.661-2.937a6.835 6.835 0 0 1 4.886 1.917 6.898 6.898 0 0 1 2.105 4.827v95.971c-.005 4.056-3.164 7.402-7.196 7.621z"
                            />
                            <path
                                fill="#2BD0D0"
                            ...
                            <path
                                fill="#3A3054"
                                d="M427.773 251.138 391.478 255s-11.053-2.23-10.455-3.862c.599-1.633 12.156-3.205 12.156-3.205v-65.804c-.1-.146-1.621-2.084-5.789-3.319a20.87 20.87 0 0 0-2.459-.57 7.252 7.252 0 0 1-2.06-.624c-2.479-1.28.26-3.51 4.107-3.61a9.625 9.625 0 0 1 1.802.106h27.913s10.568 2.973 11.08 17.811c.511 14.839 0 59.215 0 59.215z"
                            />
                            <path
                                fill="#51466B"
                                d="M398 251.277 391.322 255s-10.888-2.23-10.299-3.863c.59-1.632 11.995-3.205 11.995-3.205v-65.809c-.138-.152-1.807-1.898-5.703-3.318a28.64 28.64 0 0 0-4.452-1.195c-2.442-1.28.255-3.51 4.046-3.61 3.228.445 9.585 4.028 9.998 6.073.412 2.044 1.093 71.204 1.093 71.204z"
                            />
                            <path
                                fill="url(#u)"
