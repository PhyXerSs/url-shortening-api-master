...
function Benefit() {
  return (
    <div className="w-full flex flex-col lg:min-h-[500px] justify-center items-center relative py-20 lg:py-0 gap-28 lg:gap-0">
        <div className="w-[10px] lg:w-full h-[80%] lg:h-[10px] bg-[#24d0cf] absolute lg:relative"></div>
        <div className="relative lg:absolute lg:left-0 lg:top-[82px] w-full max-w-[380px] px-8 pb-10 pt-[75px] bg-white rounded-lg flex flex-col items-start gap-4">
            <p className="text-[#333237] text-[24px] font-[700]">Brand Recognition</p>
            <p className="text-[18px] text-[#9c9ba3] font-[500]">
                {`Boost your brand recognition with each click. Generic links don't mean a thing. Branded links help instil confidence in your content.`}
            </p>
            <div className="flex p-7 rounded-full bg-[#3a3053] absolute -top-12 left-1/2 transform -translate-x-1/2 lg:translate-x-0 lg:left-8">
        ...
        <div className="relative lg:absolute lg:left-[435px] lg:top-[130px] w-full max-w-[380px] px-8 pb-10 pt-[75px] bg-white rounded-lg flex flex-col items-start gap-4">
            <p className="text-[#333237] text-[24px] font-[700]">Detailed Records</p>
            <p className="text-[18px] text-[#9c9ba3] font-[500]">
        ...
        <div className="relative lg:absolute lg:left-[870px] lg:top-[178px] w-full max-w-[380px] px-8 pb-10 pt-[75px] bg-white rounded-lg flex flex-col items-start gap-4">
            <p className="text-[#333237] text-[24px] font-[700]">Fully Customizable</p>
            <p className="text-[18px] text-[#9c9ba3] font-[500]">
